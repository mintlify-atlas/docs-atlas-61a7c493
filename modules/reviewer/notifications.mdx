...
description: "FCM push and database notifications alert applicants and revisors to document events; revisor unread counts are injected as Inertia props per page render."
---
