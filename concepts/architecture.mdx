---
title: "Platform Architecture: Laravel, Vue 3, and Inertia.js"
sidebarTitle: "Architecture"
description: "Understand how Sistema de Admisión Web is structured — Laravel 11 backend, Vue 3 SPA frontend via Inertia.js, MySQL database, Redis cache, and Firebase for push notifications."
---
...
| SPA bridge | Inertia.js (`@inertiajs/inertia-vue3`) | ^0.6.0 |
...
// web.php itself contains:
//   Route::prefix('admin')->middleware('auth','admin')->group(...)   → /admin/*
//   Route::prefix('revisor')->middleware('auth','revisor')->group(...) → /revisor/* (revisor.php)
//   Route::prefix('postulante')->middleware('auth')->group(...)      → /postulante/*
//   Route::prefix('simulacro')->middleware('auth','simulacro')       → /simulacro/*
